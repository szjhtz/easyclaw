export default {
  ...
  tutorial: {
    ...
    chat: {
      ...
      modelSelectBody: "Switch between different AI models on the fly. The current model is shown here. Changing the model takes effect immediately for the next message.",
      ...
      runProfileBody: "Select a Run Profile to control which tools are available for this conversation. 'Default' provides system tools only. Other profiles add specific capabilities (e.g., browser automation). The selection resets when you switch to a new session tab. Manage profiles in your Account page.",
      resetBtnTitle: "Reset Session",
      resetBtnBody: "Clears the agent's conversation memory for this session. The chat history stays visible, but the agent starts fresh with no context from previous messages. Useful when you want to change topics completely.",
    ...
    account: {
      ...
      welcomeBody: "The Account page is your command center for profile, subscription, tool access control, and execution configurations. Let's walk through every section.",

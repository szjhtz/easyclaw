export default {
  ...
  stt: {
    ...
    volcengineAppKey: "Volcengine App Key",
    volcengineAppKeyPlaceholder: "Enter your Volcengine app key",
    volcengineAccessKey: "Volcengine Access Key",
    volcengineAccessKeyPlaceholder: "Enter your Volcengine access key",
    volcengineKeysRequired: "Both Volcengine app key and access key are required.",
    volcengineHelp: "Get your API keys from",

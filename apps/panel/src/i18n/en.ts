export default {
  ...
  chat: {
    ...
    timeoutNoEvents: "No response received. The gateway may be unavailable — check that the agent is running.",
    timeoutWaitingForLLM: "The agent started processing, but the model has not responded. The model may be slow or the API key may be misconfigured.",
    timeoutToolRunning: "The agent is executing a tool that is taking longer than expected. You can wait or try again.",
  ...
  providers: {
    ...
    localInfoBody: "1. Install Ollama from ollama.com\n2. Run: ollama pull llama3.2\n3. Start server: ollama serve\n4. Enter the server URL below",

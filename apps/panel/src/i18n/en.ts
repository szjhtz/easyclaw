export default {
  ...
  channels: {
    ...
    // WeCom fields
    wecomTitle: "WeChat Work Customer Service",
    wecomDescription: "Connect via WeChat Work relay server",
    wecomConfigure: "Configure",
    wecomDisconnect: "Disconnect",
    wecomRelayUrl: "Relay Server URL",
    wecomRelayUrlPlaceholder: "wss://relay.easy-claw.com",
    wecomRelayUrlHint: "WebSocket URL of the WeCom relay server",
    wecomBindingToken: "Binding Token",
    wecomInstructions: "Send this token as your first message after scanning the QR code",
    wecomConnect: "Connect",
    wecomConnecting: "Connecting...",
    wecomStatusPending: "Waiting for binding",
    wecomStatusBound: "Bound",
    wecomStatusActive: "Active",
    wecomStatusError: "Error",
    wecomStatusNotConnected: "Not connected",
    wecomRelayConnected: "Relay connected",
    wecomBindingModalTitle: "Configure WeChat Work",
    wecomFailedToBind: "Failed to bind WeCom account:",
    wecomFailedToFetchStatus: "Failed to fetch WeCom status",
    wecomExternalUserId: "External User ID",
    wecomTokenCopied: "Token copied!",
    wecomCopyToken: "Copy",
    // Common labels
